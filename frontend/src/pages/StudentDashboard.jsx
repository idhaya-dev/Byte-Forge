        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-lg space-y-4">
            ...
            <div className="space-y-3">
              <Link
                to="/student/feedback"
                className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 transition group"
              >
                <div className="p-2.5 bg-blue-500/10 rounded-lg text-blue-600 group-hover:scale-110 transition duration-200">
                ...
                <div>
                  <span className="font-semibold text-sm text-slate-800">Submit New Feedback</span>
              ...
              <Link
                ...
                className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 transition group"
              >
                <div className="p-2.5 bg-slate-100 rounded-lg text-slate-600 group-hover:scale-110 transition duration-200">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <span className="font-semibold text-sm text-slate-800">Review Submission Logs</span>

    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">Loading submission logs...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-white">Feedback Submission Logs</h1>
      ...
      <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs text-slate-400 flex items-start gap-3">
        ...
        <div>
          <p className="font-bold text-slate-300">Anonymity Safeguard Policy</p>
      ...
      {filteredHistory.length === 0 ? (
        <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-12 text-center space-y-4">
          ...
          <div className="space-y-2 max-w-sm mx-auto">
            <h3 className="text-white font-bold">No evaluation logs found</h3>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50 text-sm text-slate-300">
                {filteredHistory.map((item) => (
                  <tr key={item._id} className="hover:bg-slate-950/30 transition">
          ...
          <div className="md:hidden divide-y divide-slate-800/60">
            {filteredHistory.map((item) => (
              <div key={item._id} className="p-5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xxs p-3 bg-slate-950/40 rounded-xl border border-slate-850/40">
                  <div>

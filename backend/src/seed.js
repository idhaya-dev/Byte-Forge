...
const seedDatabase = async () => {
  try {
    ...
    await Appraisal.create({
      ...
      status: 'Submitted By Faculty',
      selfAppraisal: {
        teachingHours: 420,
        researchPapersCount: 2,
        booksPublishedCount: 1,
        studentProjectsGuided: 8,
        selfRating: 4,
        achievements: 'Successfully secured research funding of $50,000 for quantum cryptography analysis and organized a successful national workshop.',
        challengesText: 'Managing research deadlines alongside semester workload was a challenge, but goals were successfully met.',
        submitted: true,
